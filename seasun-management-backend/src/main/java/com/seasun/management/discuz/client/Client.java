package com.seasun.management.discuz.client;
...
public class Client extends PHPFunctions{
	...
	@Value("${uc_ip}")
	public String UC_IP = "127.0.0.1";
	@Value("${uc_api}")
	public String UC_API = "http://localhost/uc";
	@Value("${uc_connect}")
	public String UC_CONNECT = "";
	@Value("${uc_key}")
	public String UC_KEY = "123456";
	@Value("${uc_appid}")
	public String UC_APPID = "3";
	
	public boolean IN_UC = true;
	public String UC_CLIENT_VERSION = "1.6.0";
	public String UC_CLIENT_RELEASE = "20170101";
	public String UC_ROOT = "";		//note 用户中心客户端的根目录 UC_CLIENTROOT
	public String UC_DATADIR = UC_ROOT+"./data/";		//note 用户中心的数据缓存目录
	public String UC_DATAURL = "UC_API"+"/data";			//note 用户中心的数据 URL
	public String UC_API_FUNC = UC_CONNECT.equals("mysql") ? "uc_api_mysql" : "uc_api_post";
	public String[] uc_controls = {};
...
//		}
	...
	*/
	...
	public String uc_user_register(String $username, String $password, String $email, String $questionid, String $answer) {
		return uc_user_register($username, $password, $email, $questionid, $answer, "");
	}
	
	public String uc_user_register(String $username, String $password, String $email, String $questionid, String $answer, String $realname) {
